...
func Setup(
	...
	rizzHandler *handlers.RizzHandler,
) {
	api := app.Group("/api")
	...
	// Rizz - AI Response Generator (protected)
	rizz := protected.Group("/rizz")
	rizz.Post("/generate", rizzHandler.Generate)
	rizz.Get("/stats", rizzHandler.GetStats)
	rizz.Get("/history", rizzHandler.GetHistory)
